p '23. Дано дійсне число R і масив дійсних чисел. Знайти елемент масиву, який найбільш близький до цього числа'
p 'R=51.3333333'
...
p array[array.map{ |x| (x-r).abs}.index(array.map{ |x| (x-r).abs}.min)]
